...
| F09    | Avaliação por Múltiplos Avaliadores        | Permitir que de 3 a 5 avaliadores avaliem o mesmo projeto de forma independente.                                                                                 | Essencial    |
| F10    | Consolidação de Avaliações                 | Permitir que os avaliadores, após realizarem suas avaliações individuais, consolidem os resultados em uma única avaliação final do projeto.                      | Essencial    |
| F11    | Identificação de Erros Comuns              | Permitir a identificação automática ou manual dos erros que foram encontrados por mais de um avaliador.                                                         | Essencial   |
| F12    | Resumo da Avaliação Consolidada            | Gerar um resumo da avaliação final, indicando os erros consensuais, erros únicos e soluções propostas.                                                           | Essencial   |
| F13    | Controle de Status da Avaliação            | Permitir que um projeto tenha status como: "Em Avaliação Individual", "Em Consolidação" e "Avaliação Consolidada".                                                | Essencial   |
